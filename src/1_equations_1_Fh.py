...
# --- Symbols ---
E, I, L = sp.symbols('E I L', positive=True, finite=True)
k1, k2 = sp.symbols('k1 k2', nonnegative=True,
...
Keff_simplified = sp.simplify(sp.factor(Keff))

# The required horizontal force for u2 = 1 is F = Keff
F_expr = sp.simplify(Keff_simplified)

# --- Adimensional form with alpha_i = k_i*L/(E*I) ---
alpha1, alpha2 = sp.symbols('alpha1 alpha2', nonnegative=True)
subs_dimless = {
    k1: alpha1 * (E*I)/L,
    k2: alpha2 * (E*I)/L
}
F_dimless = sp.simplify(sp.factor(sp.together(
